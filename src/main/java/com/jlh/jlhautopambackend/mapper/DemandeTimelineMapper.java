...
public interface DemandeTimelineMapper {
    ...
    DemandeTimelineEntryDto toDto(DemandeTimeline entity);

    default StatutDemandeDto toStatutDto(DemandeTimeline entity) {
        if (entity == null || entity.getStatutCode() == null) {
            return null;
        }
    ...
    default boolean isDocumentEvent(DemandeTimeline entity) {
        return entity != null && entity.getType() == DemandeTimelineType.DOCUMENT;
    }
}
